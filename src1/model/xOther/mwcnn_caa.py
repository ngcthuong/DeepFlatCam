...
class BSR(nn.Module):
    ...
    def forward(self, x):
        ...
        x1 = self.d_l1(self.head(self.FCA1(self.DWT(x))))
        x2 = self.d_l2(self.FCA2(self.DWT(x1)))
        # x3 = self.d_l2(self.DWT(x2))
        x_ = self.ICA1(self.IWT(self.pro_l3(self.FCA3(self.DWT(x2))))) + x2
        x_ = self.ICA2(self.IWT(self.i_l2(x_))) + x1
